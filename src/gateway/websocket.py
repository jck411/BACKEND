...
class WebSocketGateway:
    ...
    async def _message_loop(self, websocket: WebSocket, connection_id: str, user_id: Optional[str]) -> None:
        ...
        while True:
            try:
                ...
                message_data = await asyncio.wait_for(
                    ...
                    timeout=self.config.gateway.connection_timeout
                )
    ...
    async def _process_message(self, message_data: str, connection_id: str, user_id: Optional[str]) -> None:
