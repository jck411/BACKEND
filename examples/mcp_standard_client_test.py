...
- POST /tools/list - Discover available tools (MCP 2025 spec)
- POST /tools/call - Execute tools with parameters

This follows the official MCP 2025 specification for tool discovery and execution.
...
class MCPStandardClient:
    ...
    async def list_tools(self):
        ...
        try:
            response = await self.client.post(f"{self.base_url}/tools/list", json={})
...
async def test_mcp_endpoints():
    ...
    try:
        ...
        # 2. Tool Discovery
        print("\n2. 🔍 Tool Discovery (POST /tools/list)")
        print("-" * 40)
        ...
        print("\n📊 Summary:")
        print("   • Standard MCP endpoints working: /tools/list, /tools/call")
        print("   • Tool discovery and execution functional")
        print("   • Error handling working correctly")
        print("   • Vendor-agnostic tool interface operational")
